...
func Save[T model.BaseModel](ctx context.Context, coll *mongo.Collection, entity T) (T, error) {
	if entity.GetID() == "" {
...
func SaveAll[T model.BaseModel](ctx context.Context, coll *mongo.Collection, entities []T) ([]T, error) {
	var savedEntities []T
...
func FindAll[T model.BaseModel](ctx context.Context, coll *mongo.Collection, entityType T) ([]T, error) {
	var results []T
...
func FindAllBy[T model.BaseModel](ctx context.Context, coll *mongo.Collection, entityType T, filter bson.M, findOptions *options.FindOptions) ([]T, error) {
	var results []T
...
func FindByID[T model.BaseModel](ctx context.Context, coll *mongo.Collection, id string, entityType T) (T, error) {
	var entity T
...
func FindBy[T model.BaseModel](ctx context.Context, coll *mongo.Collection, filter bson.M, entityType T) (T, error) {
	var entity T
...
func FindByName[T model.BaseModelName](ctx context.Context, coll *mongo.Collection, name string, entityType T) (T, error) {
	var entity T
...
func StreamAll[T model.BaseModel](ctx context.Context, db *mongo.Collection, filter bson.M) (<-chan T, <-chan error) {
