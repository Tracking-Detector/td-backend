...
func (_m *IExportRunService) GetAll(ctx context.Context) ([]*model.ExportRun, error) {
	ret := _m.Called(ctx)
...
func (_m *IExportRunService) GetByExporterID(ctx context.Context, exporterId string) ([]*model.ExportRun, error) {
...
func (_m *IExportRunService) GetByID(ctx context.Context, id string) (*model.ExportRun, error) {
...
func (_m *IExportRunService) Save(ctx context.Context, exportRun *model.ExportRun) (*model.ExportRun, error) {
