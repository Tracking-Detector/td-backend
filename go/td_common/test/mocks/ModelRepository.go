...
func (_m *ModelRepository) FindAll(ctx context.Context) ([]*model.Model, error) {
	ret := _m.Called(ctx)
...
func (_m *ModelRepository) FindByID(ctx context.Context, id string) (*model.Model, error) {
	ret := _m.Called(ctx, id)
...
func (_m *ModelRepository) FindByName(ctx context.Context, name string) (*model.Model, error) {
...
func (_m *ModelRepository) Save(ctx context.Context, entity *model.Model) (*model.Model, error) {
...
func (_m *ModelRepository) SaveAll(ctx context.Context, entity []*model.Model) ([]*model.Model, error) {
	ret := _m.Called(ctx, entity)
...
func (_m *ModelRepository) StreamAll(ctx context.Context) (<-chan *model.Model, <-chan error) {
	ret := _m.Called(ctx)
	...
	var r0 <-chan *model.Model
	var r1 <-chan error
	if rf, ok := ret.Get(0).(func(context.Context) (<-chan *model.Model, <-chan error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) <-chan *model.Model); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(<-chan *model.Model)
		}
	}
