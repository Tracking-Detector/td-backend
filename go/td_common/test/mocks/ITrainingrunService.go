...
func (_m *ITrainingrunService) FindAllByModelId(ctx context.Context, modelId string) ([]*model.TrainingRun, error) {
...
func (_m *ITrainingrunService) FindAllTrainingRuns(ctx context.Context) ([]*model.TrainingRun, error) {
	ret := _m.Called(ctx)
...
func (_m *ITrainingrunService) FindAllTrainingRunsForModelname(ctx context.Context, modelName string) ([]*model.TrainingRun, error) {
