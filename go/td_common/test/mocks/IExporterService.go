...
func (_m *IExporterService) FindByID(ctx context.Context, id string) (*model.Exporter, error) {
...
func (_m *IExporterService) GetAllExporter(ctx context.Context) ([]*model.Exporter, error) {
	ret := _m.Called(ctx)
